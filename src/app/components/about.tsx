              ...
              <div className="flex items-start gap-4">
                <div>
                  ...
                  <ul className="space-y-4 text-slate-600">
                    {[
                      "🎓 B.E. IT at VESIT | CGPA: 9.55 (till Sem 7)",
